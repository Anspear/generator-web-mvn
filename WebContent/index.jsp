	...
	<div class="container">
		...
		<form class="form-horizontal" role="form" id="form">
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
					<input type="text" class="form-control" placeholder="192.168.0.90" id="connection" name="connection" value="localhost" required/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-xs-4">
					<input type="text" placeholder="3306" id="port" name="port" class="form-control" value="3306" required/>
				</div>
				<label for="dataBase" class="col-lg-2 control-label">数据库</label>
				<div class="col-xs-4">
					<input type="text" placeholder="databaseName" id="dataBase" name="dataBase" class="form-control" value="books" required/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-xs-4">
					<input type="text" placeholder="root" id="userId" name="userId" class="form-control" value="root" required/>
				</div>
				<label for="userPass" class="col-lg-2 control-label">密码</label>
				<div class="col-xs-4">
					<input type="text" placeholder="password" id="userPass" name="userPass" class="form-control" value="123456" required/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
					<input type="text" class="form-control" placeholder="com.yourCompany.core.entity" id="modelPath" name="modelPath" value="com.ja.core.entity" required/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
					<input type="text" class="form-control" placeholder="com.yourCompany.core.dao" id="daoPath" name="daoPath" value="com.ja.core.dao" required/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
					<input type="text" class="form-control" placeholder="mybatis.mapper" id="mappingPath" name="mappingPath" value="mybatis.mapper" required/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-xs-3">
					<input type="text" id="tableNames" name="tableNames" class="form-control" value="t_book" required/>
				</div>
				<label for="modelNames" class="col-lg-2 control-label">模型名</label>
				<div class="col-xs-3">
					<input type="text" id="modelNames" name="modelNames" class="form-control" value="Book" required/>
				</div>
